...
class ProductModels
{
    ...
    {
        $sql = "SELECT * FROM sub_product_category JOIN product as p on sub_product_category.category_sub = p.category_sub WHERE sub_product_category.codeSUB='$category_id[1]' AND is_disabled_sub='0' AND is_disabled='0'";
        $stmt = $this->db->query($sql);
