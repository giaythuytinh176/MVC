    ...
    <section id="page-title">
        <div class="container clearfix"><?php
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="<?php str_replace("/".(new \MVC\controllers\CategoryControllers())->getDetaiElementbyCode($data[2][0])['code'], "", \MVC\controllers\UrlControllers::url($data[1])) ?>"><?php echo strtoupper($data[1]);?></a></li>
                <li class="breadcrumb-item active" aria-current="page"><?php echo (new \MVC\controllers\CategoryControllers())->getDetaiElementbyCode($data[2][0])['title'];?></li>
            </ol>
        </div>
