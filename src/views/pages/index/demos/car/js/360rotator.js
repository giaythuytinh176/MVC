        ...
        e.$el = a(b), e.el = b, e.$el.data("ThreeSixty", e), e.init = function () {
            ...
            if (d.navigation && !d.navigation_init) {
                ...
                b = a("<div/>").attr("class", "nav_bar"), c = a("<a/>").attr({
                    ...
                    href: "#",
                    "class": "nav_bar_play"
                }).html("play"), b.append(f), b.append(g), b.append(c), e.$el.prepend(b), c.on("mousedown touchstart", e.next), f.on("mousedown touchstart", e.previous), g.on("mousedown touchstart", e.play_stop), d.navigation_init = !0
            }
            ...
            var c = a || d.playSpeed, f = b || d.autoplayDirection;
            ...
            e.$el.on("mousedown touchstart touchmove touchend mousemove click", function (a) {
