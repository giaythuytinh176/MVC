                ...
                <div id="rev_slider" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.0.4.1">
                    <ul>
                        <?php foreach ($videos as $video) :
                            ...
                            ?>
                            <!-- SLIDE  -->
                            <li data-index="rs-<?php echo $video->id; ?>" data-transition="scaledownfrombottom"
                                data-slotamount="7" data-easein="Power3.easeInOut" data-easeout="Power3.easeInOut"
                                data-masterspeed="1500" data-thumb="<?php echo $video->thumbnail_medium; ?>"
                                data-rotate="0" data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7"
                                data-saveperformance="off" data-title="<?php echo $video->title; ?>"
                                data-param1="<?php echo $video->upload_date; ?>" data-description="">
                                <!-- MAIN IMAGE -->
                                <img src="<?php echo $video->thumbnail_large; ?>" alt="Image"
