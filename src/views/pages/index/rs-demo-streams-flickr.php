            ...
            <div id="rev_slider" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.0.4.1">
                <ul>    <!-- SLIDE  -->
                    <?php foreach ($photos as $photo) :
                        //var_dump($photo);
                        ?>
                        <li data-index="rs-<?php echo $photo->id; ?>" data-transition="scaledownfrombottom"
                            data-slotamount="7" data-easein="default" data-easeout="default" data-masterspeed="1500"
                            data-thumb="<?php echo $photo->url_l; ?>" data-rotate="0" data-fstransition="fade"
                            data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off"
                            data-title="<?php echo $photo->title; ?>" data-param1="<?php echo $photo->datetaken; ?>"
                            data-description="">
                            <!-- MAIN IMAGE -->
                            <img src="include/rs-plugin/demos/assets/images/dummy.png" alt="Image"
                                 data-lazyload="<?php echo $photo->url_l; ?>" data-bgposition="center center"
                                 data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
                            <!-- LAYERS -->
                            <!-- LAYER NR. 1 -->
                            <a class="tp-caption WebProduct-Menuitem  "
                               href="<?php echo 'https://flic.kr/p/' . TP_flickr::base_encode($photo->id); ?>"
                               target="_blank"
