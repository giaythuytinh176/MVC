                                        ...
                                        <div class="mega-menu-content">
                                            <div class="row mx-0">
                                                <ul class="sub-menu-container mega-menu-column col-5">
                                                    ...
                                                    <li class="menu-item">
                                                        <a class="menu-link" href="page-titledark.html">
                                                            <div>Dark Style</div>
                                                        </a>
                                                    </li>
                                                    <li class="menu-item">
                ...
                <div id="rev_slider" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.0">
                    <ul>
                        <?php foreach ($tweets as $tweet):
                            ...
                            ?>
                            <!-- SLIDE  -->
                            <li data-index="rs-<?php echo $tweet['id']; ?>" data-transition="scaledownfromleft"
                                data-slotamount="default" data-easein="default" data-easeout="default"
                                data-masterspeed="1500" data-thumb="<?php echo $image_url[0]; ?>" data-rotate="0"
                                ...
                                echo $date->format('F d, Y'); ?>" data-param2="<?php echo $tweet['text']; ?>"
                                data-description="">
                                <!-- MAIN IMAGE -->
                                <img src="include/rs-plugin/demos/assets/images/dummy.png" alt="Image"
                                     data-lazyload="<?php echo $image_url[0]; ?>" data-bgposition="center center"
                                ...
                                <div class="tp-caption Twitter-Retweet  "
                                     ...
                                     data-end="bytrigger"
                                     data-lasttriggerstate="reset"
                                     style="z-index: 6; min-width: auto; min-height: auto; white-space: nowrap; max-width: auto; max-height: auto; font-size: 15px; line-height: 22px; font-weight: 500; color: rgba(136, 153, 166, 1.00);font-family:Roboto;background-color:rgba(255, 255, 255, 0);border-radius:0 0 0 0;">
                                    <i class="icon-twitter"></i> <?php echo $tweet['retweet_count']; ?>
                                </div>
                                ...
                                <div class="tp-caption Twitter-Favorites  "
                                     ...
                                     data-end="bytrigger"
                                     data-lasttriggerstate="reset"
                                     style="z-index: 7; min-width: auto; min-height: auto; white-space: nowrap; max-width: auto; max-height: auto; font-size: 15px; line-height: 22px; font-weight: 500; color: rgba(136, 153, 166, 1.00);font-family:Roboto;background-color:rgba(255, 255, 255, 0);border-radius:0 0 0 0;">
                                    <i class="icon-star3"></i> <?php echo $tweet['favorite_count']; ?>
                                </div>

                                <!-- LAYER NR. 4 -->
                                <!-- LINK TO TWEET -->
                                <a class="tp-caption Twitter-Link"
                                   href="https://twitter.com/<?php echo $twitter_account; ?>/status/<?php echo $tweet['id']; ?>"
                                   target="_blank" id="slide-<?php echo $tweet['id']; ?>-layer-2"
                                   data-x="185"
                                   data-y="bottom"
                                   data-voffset="24"
                                   data-width="['auto']"
                                ...
                                style="z-index: 8; min-width: auto; min-height: auto; white-space: nowrap; max-width:
                                auto; max-height: auto; font-size: 15px; line-height: 15px; font-weight: 500; color:
                                rgba(135, 153, 165,
                                1.00);font-family:Roboto;text-align:center;background-color:rgba(255, 255, 255,
                                1.00);padding:11px 11px 9px 11px;border-radius:30px 30px 30px 30px;"><i
                                        class="icon-link"></i>
                                </a>
                                ...
                                <div class="tp-caption Twitter-Link  "
                                     ...
                                     style="z-index: 9; min-width: auto; min-height: auto; white-space: nowrap; max-width: auto; max-height: auto; font-size: 15px; line-height: 15px; font-weight: 500; color: rgba(135, 153, 165, 1.00);font-family:Roboto;text-align:center;background-color:rgba(255, 255, 255, 1.00);padding:10px 11px 9px 11px;border-radius:50px 50px 50px 50px;">
    ...
    <section id="content">
        <div class="content-wrap">
            <div class="container clearfix">
                ...
                <a href="rs-demos.html" class="btn btn-secondary btn-lg btn-block mx-auto" style="max-width: 20rem;"><i
                            class="icon-line-arrow-left mr-2" style="position: relative; top: 1px;"></i> Back to All
                    Demos</a>
