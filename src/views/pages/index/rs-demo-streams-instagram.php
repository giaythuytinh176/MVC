    ...
    <section id="slider" class="slider-element revoslider-wrap mt-5">
        <div class="container">
            ...
            <div id="rev_slider_wrapper" class="rev_slider_wrapper fullwidthbanner-container"
                 style="margin:0px auto;background-color:#111111;padding:0px;margin-top:0px;margin-bottom:0px;background-repeat:no-repeat;background-size:cover;background-position:center center;">
                ...
                <div id="rev_slider" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.0">
                    <ul>    <!-- SLIDE  -->
                        ...
                        foreach ($photos as $photo) :
                            ...
                            ?>
                            <li data-index="rs-<?php echo $photo->created_time; ?>" data-transition="incube-horizontal"
                                data-slotamount="1" data-easein="default" data-easeout="default" data-masterspeed="600"
                                data-thumb="<?php echo $image_url; ?>" data-rotate="0" data-fstransition="fade"
                                ...
                                <img src="include/rs-plugin/demos/assets/images/dummy.png" alt="Image"
                                     data-lazyload="<?php echo $image_url; ?>" data-bgposition="center center"
                                     data-bgfit="contain" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
                                <!-- LAYERS -->

                                <!-- LAYER NR. 1 -->
                                <a class="tp-caption Instagram-Caption   tp-resizeme"
                                   href="<?php echo $photo->link; ?>" target="new"
                                   id="slide-<?php echo $photo->created_time; ?>-layer-2"
                                   ...
                                   style="z-index: 5; min-width: auto; min-height: auto; white-space: nowrap; max-width: auto; max-height: auto; font-size: 13px; line-height: 20px; font-weight: 500; color: rgba(255, 255, 255, 1.00);font-family:Roboto;background-color:rgba(0, 0, 0, 0.50);padding:5px 10px 5px 10px;border-radius:0 0 0 0;"><i
                                            class="fa-icon-pencil"></i> &nbsp; <?php echo $photo->user->username; ?>
                                    &nbsp; &nbsp; <i class="fa-icon-heart"></i>
                                    &nbsp; <?php echo $photo->likes->count; ?>
                                </a>
                            </li>
                        <?php endforeach; ?>
                    </ul>
