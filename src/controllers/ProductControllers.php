...
class ProductControllers extends ProductModels
{
    ...
    {
        return parent::getProductDetailbyID($id);
    }
    ...
    public function showDetailProduct($data)
    {
        ...
        $product_price = (!empty($data[0]['discount']) && $data[0]['discount'] > 0) ? '<del>' . number_format($data[0]['price']) . ' ₫ </del><ins>' . number_format(($data[0]['price'] * (100 - $data[0]['discount']) / 100)) . '₫ </ins>' : '<ins>' . number_format($data[0]['price']) . ' ₫ </ins>';
