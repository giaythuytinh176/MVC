    ...
    <div class="row">
        ...
        <div class="col-xl-12 col-lg-12">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <?php
                    if (!empty($_POST['btn'])) {// && !empty($_POST['product_name']) && !empty($_POST['price']) && !empty($_POST['description'])
                        $errors = [];
                        $required_fields = ['product_name', 'price', 'description'];
                    ...
                    <div class='table-responsive'>
                        ...
                        $sout .= '<table id="EditProduct" class="table table-borderless" cellspacing="0"
                            ...
                            <tr>
                                ...
                                <th style="width: 30%" class="warning"><input type="text" class="form-control"name="category_id" value="' . $ProductDetail['category_id'] . '" disabled></th>
                                <th></th>
                            </tr>
                            <tr>
                                <th></th>
                                <th style="width: 30%" class="success">Product SubCategory</th>
                                <th style="width: 30%" class="warning"><input type="text" class="form-control"name="category_sub" value="' . (empty($ProductDetail['category_sub']) ? "Sub Parrent" : $ProductDetail['category_sub']) . '" disabled></th>
                                <th></th>
                            </tr>
                            <tr>
                                <th></th>
                                <th style="width: 30%" class="success">Price</th>
                                <th style="width: 30%" class="warning"><input type="text" class="form-control"name="price" value="' . $ProductDetail['price'] . '"></th>
                                <th></th>
                            </tr>
                            <tr>
                                <th></th>
