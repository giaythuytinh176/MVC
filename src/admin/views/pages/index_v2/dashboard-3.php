          ...
          <li class="dropdown messages-menu"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <i class="icon-envelope"></i>
            ...
            <ul class="dropdown-menu">
              ...
              <li>
                <ul class="menu">
                  <li><a href="#">
                    <div class="pull-left"><img src="dist/img/img1.jpg" class="img-circle" alt="User Image"></div>
                    <h4>Florence Douglas</h4>
                    <p>Lorem ipsum dolor sit amet.</p>
                    <p><small><i class="fa fa-clock-o"></i> 2 mins</small></p>
                    </a></li>
                  <li><a href="#">
                    <div class="pull-left"><img src="dist/img/img2.jpg" class="img-circle" alt="User Image"></div>
                    <h4>Douglas Smith</h4>
                    <p>Lorem ipsum dolor sit amet.</p>
                    <p><small><i class="fa fa-clock-o"></i> 15 mins</small></p>
                    </a></li>
                  <li><a href="#">
                    <div class="pull-left"><img src="dist/img/img3.jpg" class="img-circle" alt="User Image"></div>
                    <h4>Lorence Deo</h4>
                    <p>Lorem ipsum dolor sit amet.</p>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active"><a href="#"><i class="fa fa-dashboard"></i> <span>Dashboard</span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span> </a>
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="dashboard-3.html"><i class="fa fa-angle-right"></i> Dashboard 3</a></li>
          </ul>
        </li>
  ...
  <div class="content-wrapper"> 
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><i class="fa fa-dashboard"></i> Dashboard 3</li>
      </ol>
    </section>
      ...
      <div class="row">
        <div class="col-lg-3 col-xs-6">
          <div class="media-box plain">
            <div class="media-rate pull-right">20%</div>
        ...
        <div class="col-lg-3 col-xs-6">
          <div class="media-box plain">
            <div class="media-rate red pull-right">45%</div>
            <div class="media-info">
              <h3>$8,530</h3>
              <h5>Total Payment</h5>
            </div>
        ...
        <div class="col-lg-3 col-xs-6">
          <div class="media-box plain">
            <div class="media-rate green pull-right">60%</div>
            <div class="media-info">
              <h3>935</h3>
              <h5>Total Sales</h5>
            </div>
        ...
        <div class="col-lg-3 col-xs-6">
          <div class="media-box plain">
            <div class="media-rate blue pull-right">80%</div>
            <div class="media-info">
              <h3>5324</h3>
              <h5>New Orders</h5>
            </div>
