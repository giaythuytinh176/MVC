...
--
-- Host: localhost
-- Generation Time: Dec 03, 2020 at 09:07 AM
...
--
-- Stand-in structure for view `allcategoryproducts`
-- (See below for the actual view)
--
CREATE TABLE `allcategoryproducts` (
`category_id` int
...
(12, 'donghothongminh', 'Đồng hồ thông minh', 6, 0),
...
(28, 8, NULL, 'Chuột không dây Bluetooth A4Tech FB35', NULL, '222000.0000', 0, 'Chuột không dây Bluetooth A4Tech FB35 – Độ cảm biến cao, tuổi thọ dài\nBạn đang dùng chuột máy tính có dây, nó rất dễ vướng víu và gây ra những bất tiện nên muốn thay thế qua loại chuột không dây. Vì thế dòng sản phẩm chuột không dây A4Tech FB35 đã được ra đời để có thể đáp ứng được thị trường và nhu cầu của người sử dụng hiện nay.\n\n', NULL, 0, NULL, 'http://localhost/MVC_shop_test/uploads/new_project_6_1.jpg', 'https://cdn.cellphones.com.vn/media/catalog/product/cache/1/image/1000x/040ec09b1e35df139433887a97daa66f/n/e/new_project_2__8.jpg\nhttps://cdn.cellphones.com.vn/media/catalog/product/cache/1/image/1000x/040ec09b1e35df139433887a97daa66f/n/e/new_project_6_1.jpg\nhttp://localhost/MVC_shop_test/uploads/new_project_6_1.jpg', NULL, 0);
...
--
ALTER TABLE `parent_category`
  MODIFY `parent_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
...
--
ALTER TABLE `product_category`
  MODIFY `category_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=56;

--
-- AUTO_INCREMENT for table `sub_product_category`
--
ALTER TABLE `sub_product_category`
  MODIFY `category_sub` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
